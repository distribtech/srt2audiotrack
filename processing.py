...
def modify_subtitles(subtitle: Path, vocabular_pth: Path):
...
def convert_to_csv(directory: Path, subtitle_name: str, out_path: Path, speakers: dict, default_speaker: dict):
...
def fast_rglob(root_dir: str | Path, extension: str, exclude_ext: str):
